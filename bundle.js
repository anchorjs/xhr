...
var Request = require('./lib/request'), uri = require('url');
...
exports.get = get;
},{"url":2,"./lib/request":3}],2:[function(require,module,exports){
...
var Response = require('./response'), AjaxError = require('./errors/ajaxerror'), Emitter = require('events'), clazz = require('class');
...
Request.prototype.send = function (data) {
    var self = this, xhr = new XMLHttpRequest(), res;
    this._xhr = xhr;
    ...
    if (this._mime) {
        xhr.overrideMimeType(this._mime);
    }
    xhr.send(data);
};
...
},{"events":6,"./response":7,"./errors/ajaxerror":8,"class":9}],8:[function(require,module,exports){
...
var Emitter = require('events'), clazz = require('class');
function Response() {
    Emitter.call(this);
    this.headers = {};
    this._offset = 0;
...
Response.prototype._init = function (xhr) {
    var headers = xhr.getAllResponseHeaders(), header, name, value;
...
Response.prototype._end = function (xhr) {
    this.status = this.statusCode = xhr.status;
    if (xhr.status == 1223)
        this.statusCode = 204;
